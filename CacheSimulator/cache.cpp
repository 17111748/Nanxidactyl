...
// // Buffer Sizes 
// #define NUM_BLOCKS 4
// #define BLOCK_SIZE 2 // Got to be log2(NUM_BLOCKS)
// #define ADDR_SIZE 64
...
//     state = INVALID; 
//     tag = 0;
//     data = vector<uint32_t>(NUM_BLOCKS, 0); 
//     time_accessed = 0;  
// }

// // Constructor
// Line::Line(cache_states state_param, uint64_t tag_param, uint32_t data_param, uint64_t time_accessed_param, uint8_t block_index_param) {
//     state = state_param;
//     tag = tag_param;
//     data = vector<uint32_t>(NUM_BLOCKS, 0); 
//     data[block_index_param] = data_param;
